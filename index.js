export const unitConversions = {
  ...
  "‘": 12, // curly quote
  "’": 12, // curly quote
  mm: 0.03937, //note mm comes before m - important, otherwise greedy lookup of regex below will incorrectly match mm value to 'm'
  m: 39.37,
  cm: 0.3937
};
...
export default (dimensionValue, defaultUnits = "in") => {
  ...
  return dimensionComponents.reduce((total, { value, units }) => {
    if (!units) {
      total += value * unitConversions[defaultUnits];
    } else {
